...
public class StaticServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Book> list2 = bd.getStaticSold();
        List<Book> list3 = bd.getStaticPrice();
        request.setAttribute("listStatic1", list1);
        request.setAttribute("listStatic2", list2);
        request.setAttribute("listStatic3", list3);
