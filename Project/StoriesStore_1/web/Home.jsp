...
<html>
    ...
    <body>
            ...
            <div class="header_top_right">
                    ...
                    <div class="header_top_right_regular">  
                        ...
                        <div class="ul">
                            <ul>
                                ...
                                <li>
                                    <a href="static" target="_blank"><i class="fa-solid fa-arrow-rotate-right"></i>&nbsp;&nbsp;&nbsp;Thống Kê</a>
                                </li>
                                <li>
                ...
                <c:if test="${sessionScope.customer != null}">
                    <div class="header_top_right_regular">  
                        ...
                        <div class="div_logout">
                            <a>${sessionScope.customer.username}</a>
                        </div>
                    </div>
                </c:if>
        ...
        <h1 style="color: #ffac2b; text-align: center; margin: 50px 0; text-transform: uppercase">Home</h1>
        <%--<c:if test="${sessionScope.admin != null}">--%>  
        <c:if test="${sessionScope.admin != null || sessionScope.customer != null}">  
            <!--<p style="color: #ff5f2b; text-align: center; font-size: 30px">Hello  ${sessionScope.admin.username}</p>-->           
            <p style="color: #ffc255; text-align: center; font-size: 30px">Welcome to <a style="color: #00a0d4">StoreUras</a></p>
        </c:if>
<%--        <c:if test="${sessionScope.customer != null}">  
            <!--<p style="color: #ff5f2b; text-align: center; font-size: 30px">Hello  ${sessionScope.admin.username}</p>-->           
            <p style="color: #ffc255; text-align: center; font-size: 30px">Welcome to <a style="color: #00a0d4">StoreUras</a></p>
