...
<html>
    ...
    <body>
        ...
        <div>
            <h1 style="color: #ffac2b; text-align: center; margin: 50px 0">Top 10 Truyện Hay Đọc</h1>
        </div>
        <!--product-->
        <%--<c:set var="Types_ID" value="${requestScope.Types_ID}"/>--%>
        <div class="product container">
            <form action="readhot" class="row">
                <c:forEach items="${requestScope.listBook}" var="b">
                    <div class="col-sm-3 product_card">
                        ...
                        <div class="product_body">
                            ...
                            <div class="product_evaluate"><a>Điểm Đánh Giá: </a> ${b.bookEvaluate}</div>
        ...
        <div class="next">
            ...
            <c:forEach begin="1" end="${requestScope.num}" var="i">
                <a class="${i==page?"active":""}" href="readhot?page=${i}">${i}</a>
            </c:forEach>
            <a>></a>
        </div>
        <div class="footer">
