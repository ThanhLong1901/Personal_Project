...
<html>
    ...
    <body>
        ...
        <%--        <c:set var="k" value="${requestScope.key1}" />
                <c:set var="Types_ID" value="${requestScope.Types_ID}"/>--%>
        <!--<form action="home">-->
        <%--            <c:forEach items="${requestScope.listTypes}" var="c">
                        <a href="book?Types_ID=${c.typesID}">${c.typesName}</a>                        
                    </c:forEach>--%>
                ...
                <c:forEach items="${requestScope.listBook}" var="b">
                    <div class="col-sm-3 product_card">
                        ...
                        <div class="product_body">
                            ...
                            <div class="product_sold">Đã bán: 199</a></div>
        ...
        <div class="next">
            <c:forEach begin="1" end="${requestScope.num}" var="i">
                <a class="${i==page?"active":""}" href="search?page=${i}&key=${key1}">${i}</a>
            </c:forEach>
        </div>
