...
<html>
    ...
    <body>
        ...
        <div class="menu">
            <div class="tab">
                <c:set var="TypesID" value="${requestScope.Types_ID}" />
                <c:forEach items="${requestScope.data1}" var="c">
                    <a class="${c.typesID==Types_ID?"active":""}" href="tab?Types_ID=${c.typesID}">
                        ${c.typesName}
                    </a>
                </c:forEach> 
        ...
        <div class="next">
            ...
            <c:forEach begin="1" end="${requestScope.num}" var="i">
                <a class="${i==page?"active":""}" href="tab?page=${i}&Types_ID=${BTypes_ID}">${i}</a>
            </c:forEach>
            <a>></a>
        </div>
        <div class="footer">
