...
<html>
    ...
    <body>
        ...
        <div class="forget_form">
            ...
            <div class="error">
                <a style="color: red">${requestScope.errorUpdateAdmin2}</a>
                <a style="color: red">${requestScope.errorUpdateAdmin4}</a>                
            </div>
            <form action="updateadmin" method="post">
                ...
                <div class="newpassword">
                    ...
                    <div>
                        <input type="password" placeholder="Enter your password" name="newpass"/>
                    </div>   
                </div>           
                <br/>                          
                <div class="renewpassword">
                    ...
                    <div>
                        <input type="password" placeholder="Enter your password" name="renewpass"/>
                    </div>   
                </div>           
                <br/>                          
                <br/>                          
