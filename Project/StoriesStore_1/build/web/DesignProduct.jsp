...
//                    window.location = "check?action=deleteproduct&id=" + id;
    ...
    <body>
        ...
        <div class="product container">
            <h1 style="color: #ffd700; margin-top: 60px; margin-bottom: 50px">Design Product</h1>
            <form action="designproduct" class="row">
                <c:forEach items="${requestScope.listBook}" var="b">
                    <div class="col-sm-3 product_card">
                        ...
                        <div class="product_body">
                            ...
                            <div class="product_types"><a>Thể Loại:</a> ${b.types.typesName}</div>
                            <div class="product_price"><a>Price:</a>&nbsp;&nbsp;${b.bookPrice}$</div>
                            <div class="product_choose_2">
                                <!--<a href="check?action=updateproduct&id=${b.bookID}" class="product_update">-->
                                <a href="updateproduct?id=${b.bookID}" class="product_update">
                                    <i class="fa-solid fa-wrench"></i>&nbsp;&nbsp;Update
                                </a>                  
                                <a href="#" class="product_delete" onclick="doDelete('${b.bookID}')">
        ...
        <div class="next">
            ...
            <c:forEach begin="1" end="${requestScope.num}" var="i">
                <a class="${i==page?"active":""}" href="designproduct?page=${i}">${i}</a>
            </c:forEach>
            <a>></a>
        </div>
        <div class="footer">
