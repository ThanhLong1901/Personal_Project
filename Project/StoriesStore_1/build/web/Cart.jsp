...
<html>
    <head>
        ...
        <link rel="stylesheet" href="CartStyle1.css"> 
    </head>
    <body>
        <!--header top-->
        ...
        <!--Cart-->
        <div class="menu_cart">
            <div class="menu_cart_left">Sản Phẩm</div>
            <div class="menu_cart_right">
                <div class="menu_money">Đơn Giá</div>
                <div class="menu_sold">Số Lượng</div>
                <div class="menu_totalmoney">Số Tiền</div>
                <div class="menu_delete">Thao Tác</div>
            </div>
        </div>
        ...
        <c:forEach items="${o.items}" var="i">
            <div class="menu_product">
                <div class="menu_product_top">
                    <i class="fa-solid fa-store"></i>
                    <a>${i.product.bookStore}</a>
                </div>
                <hr/>
                <div class="menu_product_end">
                    <div class="menu_product_left">
                        <div class="image">
                            <img src="images/${i.product.bookImage}" />
                        </div>
                        <div class="name_author">
                            ...
                            <div class="author">
                                ${i.product.bookAuthor}
                            </div>
                        </div>
                    </div>
                    <div class="menu_product_right">
                        <div class="product_money">
                            <fmt:formatNumber pattern="##.#" value="${i.price}"/>$
                        </div>
                        <div class="product_sold">
                            <button><a href="process?num=-1&id=${i.product.bookID}">-</a></button>
                            <input type="text" readonly  value="${i.quantity}"/>
                            <button><a href="process?num=1&id=${i.product.bookID}">+</a></button>
                        </div>
                        <div class="product_totalmoney">
                            <fmt:formatNumber pattern="##.#" value="${i.quantity*i.price}"/>$
                        </div>
                        <div class="product_delete">
                            <form action="process" method="post">
                                <input type="hidden" name="id" value="${i.product.bookID}"/>
                                <input type="submit" value="Xóa" class="input_delete"/>    
                            </form>
                        </div>
                    </div>                
                </div>
